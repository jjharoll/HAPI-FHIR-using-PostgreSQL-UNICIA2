...
public class ExampleServerDstu3IT implements IServerSupport {
  ...
  void beforeEach() {
    ...
    String ourServerBase = "http://192.168.162.23:" + port + "/fhir/";
  ...
  public void testCQLEvaluateMeasureEXM104() throws IOException {
    ...
    // http://192.168.162.23:8080/fhir/Measure/measure-EXM104-FHIR3-8.1.000/$evaluate-measure?periodStart=2019-01-01&periodEnd=2019-12-31
...
//    inParams.addParameter().setName("periodEnd").setValue(new StringType("2019-12-31"));
  ...
  public void testWebsocketSubscription() throws Exception {
    ...
    URI echoUri = new URI("ws://192.168.162.23:" + port + "/websocket");
